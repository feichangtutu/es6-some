# Try to translate Promise A+ into Chinese 欢迎指正：
English version: [Promise A+](https://promisesaplus.com/) </br>
My github [link](https://github.com/feichangtutu/es6-some/blob/master/promiseAplus_zh.md)

尝试翻译如下，
<h1 id="promisea" style="    background: #212121;
    ...
    position: relative;"><div style="width: 82px;
    height: 82px;
    background: url(https://promisesaplus.com/assets/logo-small.png);
    position: absolute;
    left: 30px;
    top: 30px;"></div>
    Promise A+</h1>
